...
<div class="card shadow mb-4 ml-4 mr-4">
    <div class="card-body">
        <div class="code-block">
            <div class="input url"><label for="OrderLink">Your Api key</label><input disabled value="<?= getSingleValDB("pengaturan", "id", "1", "api_key") ?>" placeholder="" name="url" type="url" class="form-control" required id="url" /></div>
            <br><br>
