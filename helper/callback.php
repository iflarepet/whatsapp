...
if ($msg == '' && $pesan == '') {
    ...
    if (mysqli_num_rows($cek) > 0) {
        ...
        $insert = $koneksi->query("INSERT INTO receive_chat VALUES ('','$idpesan','$nomor','$pesan','0','$nomorscanner','$datetime')");
    } else {
        $datetime = date('Y-m-d H:i:s');
        $id = rand(1111, 9999);
        $insert = $koneksi->query("INSERT INTO receive_chat VALUES ('','$id','$nomor','$pesan','0','$nomorscanner','$datetime')");
    }
}
// wa web
